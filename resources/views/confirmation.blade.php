        ...
        <div class="wrap-login100" >
            <center>
                <div class="alert alert-danger alert-block mt-3 mb-0">
                    ...
                    <strong>لقد تم ارسال رابط التفعيل الخاص في حسابك الي البريد الالكتروني يرجا تفعيل الحساب لتتمكن من عملية تسجيل الدخول</strong>
                    <a href="{{route('login',country())}}">للرجوع لصفحة تسجيل الدخول</a>
                </div>
            </center>
        </div>
    </div>
