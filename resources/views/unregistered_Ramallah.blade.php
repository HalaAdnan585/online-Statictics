                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <ul class="breadcrumb breadcrumb-style ">
                            <li class="breadcrumb-item">
                                <h4 class="page-title">الافراد الغير مسجلين-رام الله</h4>
                            </li>
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table id="tableExport"
                                    ...
                                    <thead>
                                        <tr>
                                            <th class="align-center">الاسم الكامل</th>
                                            <th class="align-center">الايميل</th>
                                            <th class="align-center">اسم التجمع السكاني</th>
                                            <th class="align-center">رقم تعداد المبنى في منطقه العد</th>
                                            <th class="align-center">رقم الوحده السكنيه في المبنى</th>
                                            <!-- <th>Start date</th>
                                            <th>Salary</th>  -->
                                        </tr>
                                    </thead>
